<template>
  <header class="header-global">
    <base-nav class="navbar-main bg-default" transparent type effect="light" expand>
      ...
      <ul class="navbar-nav navbar-nav-hover align-items-lg-center">
        <li class="nav-item dropdown">
          <a href="/description" class="nav-link" data-toggle="dropdown" role="button">
            <i class="ni ni-ui-04 d-lg-none"></i>
            <span class="nav-link-inner--text">데이터셋 소개</span>
          </a>
      ...
      <ul class="navbar-nav align-items-lg-center ml-lg-auto">
        ...
        <li class="nav-item">
          <a
            class="nav-link nav-link-icon"
            href="https://github.com/Choiuijin1125/landmark"
            target="_blank"
            data-toggle="tooltip"
